...
def process_drawing_array():
    ...
    image_bytes = decoded_image.tobytes()
...
#def get_image(arr):
#    # Convert the NumPy ndarray to an image
#    image = Image.fromarray(arr)
#
#    # Create an in-memory binary stream (BytesIO) to store the image data
#    image_stream = io.BytesIO()
#    image.save(image_stream, format='JPEG')  # You can change the format to PNG, etc.
#    print(type(image_stream.getvalue()))
#
#    # Return the image data as binary and provide metadata (e.g., content type)
#    response_data = {
